    ...
    <nav className="navbar navbar-expand-lg sticky-top shadow-sm" style={styles.navbar}>
      <div className="container-fluid px-3 px-md-4">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <ul className="navbar-nav mx-auto my-3 my-lg-0 gap-1 gap-lg-2" style={styles.navList}>
...
const styles = {
  ...
  navList: {
    // Handled dynamically by Bootstrap responsive utilities
    margin: 0,
    padding: 0,
  },
...
if (typeof document !== 'undefined') {
  ...
  style.innerHTML = `
    ...
    @media (max-width: 1100px) and (min-width: 992px) {
      .navbar-expand-lg .nav-link { padding: 10px 8px !important; font-size: 0.9rem !important; }
    }
  `;
